...
module.exports = {
	...
	run: async ({ client, interaction }) => {
		...
		if (interaction.options.getSubcommand() === "song") { //you can make this the search command as it works the same way
		...
		} else if (interaction.options.getSubcommand() === "playlist") { //currently not working
            let url = interaction.options.getString("url")
            const result = await client.player.search(url, {
                requestedBy: interaction.user,
		...
		} else if (interaction.options.getSubcommand() === "search") { //plays a search term or url if not in playlist
