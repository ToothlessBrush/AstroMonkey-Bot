...
let commands: RESTPostAPIChatInputApplicationCommandsJSONBody[] = []; //long ass type
...
for (const dir of subDir) {
    ...
    for (const file of slashFiles) {
        ...
        //if command does not have a data property, throw error (shouldnt happen but makes typescipt happy)
