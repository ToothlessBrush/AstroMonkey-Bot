...
export default class PlaylistNow extends BaseCommand {
    constructor() {
        super();
    }
 ...
 *
 * @param {ChatInputCommandInteraction | ButtonInteraction} interaction discord interaction object
 * @param {IPlaylist | undefined} playlist playlist object which contains tracks
